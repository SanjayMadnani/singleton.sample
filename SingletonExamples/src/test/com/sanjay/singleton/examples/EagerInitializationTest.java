...
import com.sanjay.examples.singleton.EagerInitialization;

/**
 * Test EagerInitialization class for singleton design pattern.
 * 
 * @author SANJAY
...
public class EagerInitializationTest {
	...
	/**
	 * Test for singleton: should return same object all times. Test method for
	 * {@link com.sanjay.examples.singleton.EagerInitialization#getDefaultInstance()}.
	 */
	@Test
	public void testGetDefaultInstance() {
		assertEquals(EagerInitialization.getDefaultInstance(), EagerInitialization.getDefaultInstance());
	}
